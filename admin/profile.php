                        ...
                        <div class="row"><div class="col-md-8"><span id="message"></span><div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="website_name" id="website_name" class="form-control" required  data-parsley-trigger="keyup" />
                                        </div>
                                        <div class="form-group">
                                            <label>website Address</label>
                                            <textarea name="website_address" id="website_address" class="form-control" required ></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>website Contact No.</label>
                                            <input type="text" name="website_contact_no" id="website_contact_no" class="form-control" required  data-parsley-trigger="keyup" />
                                        </div>
                                        <div class="form-group">
                                            <label>website Logo</label><br />
                                            <input type="file" name="website_logo" id="website_logo" />
                                            <span id="uploaded_website_logo"></span>
                                        </div>
...
$(document).ready(function(){
    ...
    $('#website_name').val("<?php echo $row['website_name']; ?>");
    $('#website_address').val("<?php echo $row['website_address']; ?>");
    $('#website_contact_no').val("<?php echo $row['website_contact_no']; ?>");
    <?php
        if($row['website_logo'] != '')
        {
    ?>
    $("#uploaded_website_logo").html("<img src='<?php echo $row["website_logo"]; ?>' class='img-thumbnail' width='100' /><input type='hidden' name='hidden_website_logo' value='<?php echo $row['website_logo']; ?>' />");
    ...
    <?php
        ...
        {
    ?>
    $("#uploaded_website_logo").html("<input type='hidden' name='hidden_website_logo' value='' />");
    <?php
        }
    }
    ?>
			...
			$.ajax({
				...
				success:function(data)
				{
                    ...
                    else
                    {
                        ...
                        $('#website_contact_no').val(data.website_contact_no);

                        if(data.website_logo != '')
                        {
                            $("#uploaded_website_logo").html("<img src='"+data.website_logo+"' class='img-thumbnail' width='100' /><input type='hidden' name='hidden_website_logo' value='"+data.website_logo+"'");
                        }
                        else
                        {
                            $("#uploaded_website_logo").html("<input type='hidden' name='hidden_website_logo' value='"+data.website_logo+"'");
                        }
